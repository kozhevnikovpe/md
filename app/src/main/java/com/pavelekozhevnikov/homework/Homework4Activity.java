...
public class Homework4Activity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ProgressBar pg2 = findViewById(R.id.pg2);

        Button btn_pg_show = findViewById(R.id.button_pg_show);
        Button btn_pg_hide = findViewById(R.id.button_pg_hide);
        btn_pg_show.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btn_pg_hide.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
